          ...
          <div className='Coin_detail'>
                ...
                <div className='tt'>
                      ...
                      <Line type="monotone" dataKey="value" stroke="#1DB4FF" />
                            ...
                            {buyAmount && (
                              <p>You will receive: ~{parseFloat(estimatedBuyTokens).toFixed(2)} tokens</p>
                            )}
                          </div>

                          <div style={{ marginBottom: "20px", padding: "15px", border: "1px solid #red", borderRadius: "8px" }} className='sell-container'>
                            <h3>SELL TOKENS</h3>
                            <input
                              type="number"
                            ...
                            <button onClick={selling} disabled={!poolAddress || !sellAmount || loading} className='sell-btn'>
                              {loading ? "Selling..." : "Sell Tokens"}
                            </button>
                            {sellAmount && (
                              <p>You will receive: ~{parseFloat(estimatedSellHbar).toFixed(2)} HBAR</p>
                            )}
                          </div>
                          </div>
                        {poolAddress && (
