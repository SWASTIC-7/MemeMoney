  ...
  return (
    <div className="createFormContainer">
        <div className="createForm">
            ...
            onChange={(e) => setTokenName(e.target.value)} required/>
                </label>
                <br />
                <label>
                    SYMBOL:
            ...
            onChange={(e) => setSymbol(e.target.value)} required/>
                ...
                <label>
                    TOTAL SUPPLY:
                    <input type="number" name="totalSupply" value={totalSupply}
            onChange={(e) => setTotalSupply(e.target.value)} required/>
                </label>
                <br />
                <button className='submit_btn' type="submit" onClick={deployToken}>CREATE COIN</button>
                <button className='deploy_btn' type="submit" onClick={deployPool}>DEPLOY</button>
            </form>
        </div>
    </div>
  )
